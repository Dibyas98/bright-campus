...
let newimge = shuffleArray(imge);
let newalpha = shuffleArray(alph)
...
export default function Context({ children }) {
    ...
    return (
        <data.Provider value={{ game1, handelGame1Click, handelGame2Click, game2, alphacard, imgecard, flipcard, match, display, total, time, handleStart, click, setclick,playagain }}>
            {children}
        </data.Provider>
    )
}
